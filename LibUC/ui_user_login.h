...
"font-size:18px;\n"
"border:none;"));
        txtLine = new QLineEdit(frame);
        txtLine->setObjectName(QStringLiteral("txtLine"));
        txtLine->setGeometry(QRect(30, 290, 231, 51));
        txtLine->setStyleSheet(QLatin1String("border:1px solid #e1e0e0;\n"
"font-size:20px;"));
        lineEdit_2 = new QLineEdit(frame);
        lineEdit_2->setObjectName(QStringLiteral("lineEdit_2"));
        lineEdit_2->setGeometry(QRect(30, 150, 231, 51));
        lineEdit_2->setStyleSheet(QLatin1String("border:1px solid #e1e0e0;\n"
"font-size:20px;"));
